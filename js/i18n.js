...
const I18n = (() => {
    ...
    const translations = {
        ru: {
            ...
            'type.draw': 'Рисовалка',
            'type.draw.desc': 'Свободное творчество!',
            'type.escape': 'Побег',
            'type.escape.desc': 'Нарисуй путь!',
            'type.live': 'Выживание',
            'type.live.desc': 'Рисуй на ходу!',
            'type.endless': 'Бесконечный',
            'level': 'Уровень',
            'escape.title': 'Побег',
            'escape.start': 'СТАРТ!',
            'escape.clear': 'Стереть',
        },
        en: {
            ...
            'type.draw': 'Draw Mode',
            'type.draw.desc': 'Free creation!',
            'type.escape': 'Escape',
            'type.escape.desc': 'Draw the path!',
            'type.live': 'Survival',
            'type.live.desc': 'Draw on the run!',
